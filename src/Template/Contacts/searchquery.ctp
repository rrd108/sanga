            ...
            print $this->Form->create(
                ...
                print '<div id="query-select-box" class="small">';
                    ...
                    $filterFields = [
                        ...
                        'WorkplaceZips.zip' => __('Workplace zip'),
                        'WorkplaceZips.name' => __('Workplace city'),
                        'workplace_address' => __('Workplace address'),
                        'workplace_phone' => __('Workplace phone'),
                        'workplace_email' => __('Workplace email'),
